const PublicacionMainItem = ({ title, imgPortada, isVendido }) => {
  return (
    <div className='card w-80 bg-base-100 shadow-2xl image-full hover:opacity-80 indicator h-full'>
      ...
      <div className='card-body justify-between'>
        <span className={`indicator-item badge badge-error badge-lg ${isVendido ? 'inline-flex' : 'hidden'}`}>
...
export default PublicacionMainItem
